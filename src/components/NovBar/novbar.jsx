...
<circle cx="24" cy="22.5" r="9.5" stroke="black" stroke-width="2"/>
          ...
          <img src={img_p}></img>
          <div style={{width:'35px'}}      onClick={()=>setMenuOpen(!menuOpen)}>
...
{
  menuOpen &&       <div className={styles.div_novbar_menu} ref={menuRef}>
        <div className={styles.div_novbar_menu_elem}   onClick={() => {
